<!--- ShowAllStudentNames.cfm --->

<CFQUERY NAME="sNameList" DATASOURCE="StudentsAudit">
...
<CFSET TotalRows = sNameList.RecordCount>
...
<TABLE>
<CFLOOP QUERY="sNameList" StartRow="#URL.StartRow#" EndRow="#EndRow#">
