<!--- ShowStudentAllDetailF.cfm 
Author: Ed Kerr
Date: 1/21/13
Description: Data drill down details page Completed and Uncompleted classes
called from:   screen - needs ?Sid= 
--->
...
WHERE a.StuId = '#StuIdIn#' AND a.courseCode = c.courseCode 
ORDER BY c.coursePre, a.FlagDone, c.IQu, a.courseCode
</CFQUERY>
...
<TR>
   <TH COLSPAN = "3">List of Classes in Major</TH>
   <TH COLSPAN = "2">Prerequisites</TH>
</TR>
<!--- Display classes in Major --->
