<CFCOMPONENT DISPLAYNAME="ClassEnd" OUTPUT="false" HINT="I am the  ClassEnd class">
...
<cfset Variables.instance = structNew()>
	...
	<CFFUNCTION NAME="init" ACCESS="public"  OUTPUT="false" RETURNTYPE="any" 
    		HINT= "I am the constructor method for the All ClassEnd class">
    	<cfargument NAME="iD" TYPE="NUMERIC" REQUIRED="true" DEFAULT = 0 
        	HINT="I am the  ID" />
		<CFARGUMENT NAME="name" TYPE="string" REQUIRED="true" 
             DEFAULT="" HINT="I am the classEnd's name" />
    ...
    <cffunction NAME="setName" ACCESS="PRIVATE" OUTPUT="false" 
       HINT="I set the classEnd's name into the Variables.instance scope" >
    <cfargument NAME="name" REQUIRED="true" TYPE="STRING"
        HINT="I am the classEnd's name." />	
    ...
    <cffunction NAME="getName" ACCESS="PUBLIC" OUTPUT="false"
        HINT="I return the classEnd's name.">
